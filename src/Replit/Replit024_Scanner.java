...
public class Replit024_Scanner{
    public static void main(String[] args) {
        ...
        double weighet= scan.nextDouble();
        ...
        System.out.println("Contacts: work phone number - "+workPhoneNumber+","+" personal phone number - "+personelNumber+","+" email: "+eMail);
        System.out.println("Age: "+age);
        System.out.println("Height: "+height);
        System.out.println("Weight: "+weighet+" pounds");
