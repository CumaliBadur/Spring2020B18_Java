...
public class Replit163_Return_Methods {
   ...
   /* Instructions from your teacher:
        ...
        taskId should be only 1 greater than currentID. for example if
        we have 7 tasks(currentId is 7) so the next task id is 8 , it can't be 10.
